...
import { Classroom, Week, WeekLessons } from '@/types/lessons';
...
export default function ClassroomShow({ lessonsByWeek, classrooms, weeks, selectedClassroomId, selectedWeekId }: {
    ...
    const [value, setValue] = useState(() => {
        return localStorage.getItem('selectedClassroomId') || String(selectedClassroomId) || "";
    });
    ...
    }, [lessonsByWeek, currentWeekLessons, selectedClassroomId]);
    ...
    const handleClassroomSelect = (selectedValue: string) => {
        if (selectedValue !== value) {
            ...
            localStorage.setItem('selectedClassroomId', selectedValue);
            router.get(route('classroom', {id: selectedValue}));
        } else {
            setValue("");
        }
        closeMenu();
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium mb-2">Classroom</h3>
                                        <ClassroomSelector
                                            classrooms={classrooms}
                                            selectedClassroomId={value}
                                            onClassroomSelect={handleClassroomSelect}
                    ...
                    {hasLessons ? (
                        <>
                            <div className="hidden md:block">
                                ...
                                />
                                <LessonDisplay lessons={activeDayLessons} context="classroom" />
                            </div>
                                ...
                                <div className="h-[70vh] overflow-y-auto pr-2 -mr-2 pb-4 scroll-smooth snap-y snap-mandatory">
                                    {currentWeekLessons.map(day => (
                                        ...
                                        >
                                            ...
                                            <div className="pb-8">
                                                <LessonDisplay lessons={day.lessons} context="classroom" />
                                            </div>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="flex items-center justify-center min-h-[50vh]">
                            <div className="text-center">
                                ...
                                <p className="text-muted-foreground">
                                    Izvēlieties citu nedēļu vai klasi.
                                </p>
                            </div>
                        </div>
                    )}
