...
import { Teacher, Week, WeekLessons } from '@/types/lessons';
import TeacherSelector from '@/components/timetable/TeacherSelector';
...
export default function TeacherShow({ lessonsByWeek, teachers, weeks, selectedTeacherId, selectedWeekId }: {
    ...
    const [value, setValue] = useState(() => {
        return localStorage.getItem('selectedTeacherId') || String(selectedTeacherId) || "";
    });
    ...
    }, [lessonsByWeek, currentWeekLessons, selectedTeacherId]);
    ...
    const handleTeacherSelect = (selectedValue: string) => {
        if (selectedValue !== value) {
            ...
            localStorage.setItem('selectedTeacherId', selectedValue);
            router.get(route('teacher', {id: selectedValue}));
        } else {
            setValue("");
        }
        closeMenu();
                    ...
                    {hasLessons ? (
                        <>
                            <div className="hidden md:block">
                                ...
                                />
                                <LessonDisplay lessons={activeDayLessons} context="teacher" />
                            </div>
                                ...
                                <div className="h-[70vh] overflow-y-auto pr-2 -mr-2 pb-4 scroll-smooth snap-y snap-mandatory">
                                    {currentWeekLessons.map(day => (
                                        ...
                                        >
                                            ...
                                            <div className="pb-8">
                                                <LessonDisplay lessons={day.lessons} context="teacher" />
                                            </div>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="flex items-center justify-center min-h-[50vh]">
                            <div className="text-center">
                                ...
                                <p className="text-muted-foreground">
                                    Izvēlieties citu nedēļu vai skolotāju.
                                </p>
                            </div>
                        </div>
                    )}
